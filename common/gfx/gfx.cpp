...
void GFX_set_perspective( float fovy, float aspect_ratio, float clip_start, float clip_end, float screen_orientation )
{
    ...
    GFX_set_perspective(left, right, bottom, top, clip_start, clip_end, screen_orientation);
#endif
}

void GFX_set_perspective( float left, float right, float bottom, float top, float near, float far, float screen_orientation )
{
	mat4 mat;

...
namespace nbd {
    ...
    {
        m[ 3 ].x = m[ 0 ].x * v.x + m[ 1 ].x * v.y + m[ 2 ].x * v.z + m[ 3 ].x;
        m[ 3 ].y = m[ 0 ].y * v.x + m[ 1 ].y * v.y + m[ 2 ].y * v.z + m[ 3 ].y;
        m[ 3 ].z = m[ 0 ].z * v.x + m[ 1 ].z * v.y + m[ 2 ].z * v.z + m[ 3 ].z;
        m[ 3 ].w = m[ 0 ].w * v.x + m[ 1 ].w * v.y + m[ 2 ].w * v.z + m[ 3 ].w;
    }
